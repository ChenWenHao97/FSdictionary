...
void protobuf_AddDesc_echo_5fservice_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\022echo_service.proto\022\002fs\"\036\n\013EchoRequest\022"
    "\017\n\007message\030\001 \002(\t\"\037\n\014EchoResponse\022\017\n\007mess"
    "age\030\001 \002(\t27\n\nEchoServer\022)\n\004Echo\022\017.fs.Ech"
    "oRequest\032\020.fs.EchoResponseB\003\200\001\001", 151);
...
void EchoServer::CallMethod(const ::google::protobuf::MethodDescriptor* method,
  ...
  switch(method->index()) {
    case 0:
      Echo(controller,
             ::google::protobuf::down_cast<const ::fs::EchoRequest*>(request),
             ::google::protobuf::down_cast< ::fs::EchoResponse*>(response),
             done);
      break;
    default:
...
const ::google::protobuf::Message& EchoServer::GetRequestPrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::fs::EchoRequest::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
const ::google::protobuf::Message& EchoServer::GetResponsePrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::fs::EchoResponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *reinterpret_cast< ::google::protobuf::Message*>(NULL);
  }
